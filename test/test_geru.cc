...
void test_geru_work( Params& params, bool run, Policy policy = blam_default_policy )
{
    namespace blas = blam;
    ...
    // test error exits
    assert_throw( blas::geru( policy, Layout(0),  m,  n, alpha, A, lda, x, incx, y, incy ), blas::Error );
    assert_throw( blas::geru( policy, layout,    -1,  n, alpha, A, lda, x, incx, y, incy ), blas::Error );
    assert_throw( blas::geru( policy, layout,     m, -1, alpha, A, lda, x, incx, y, incy ), blas::Error );

    assert_throw( blas::geru( policy, Layout::ColMajor,  m,  n, alpha, A, m-1, x, incx, y, incy ), blas::Error );
    assert_throw( blas::geru( policy, Layout::RowMajor,  m,  n, alpha, A, n-1, x, incx, y, incy ), blas::Error );

    assert_throw( blas::geru( policy, layout,     m,  n, alpha, A, lda, x, 0,    y, incy ), blas::Error );
    assert_throw( blas::geru( policy, layout,     m,  n, alpha, A, lda, x, incx, y, 0    ), blas::Error );
    ...
    double time;
    {
      ...
      blas::geru( policy, layout, m, n, alpha, dx, incx, dy, incy, dA, lda );
      time = timer.seconds();
