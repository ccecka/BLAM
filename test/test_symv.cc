...
void test_symv_work( Params& params, bool run, Policy policy = blam_default_policy )
{
    namespace blas = blam;
    ...
    // test error exits
    assert_throw( blas::symv( policy, Layout(0), uplo,     n, alpha, A, lda, x, incx, beta, y, incy ), blas::Error );
    assert_throw( blas::symv( policy, layout,    Uplo(0),  n, alpha, A, lda, x, incx, beta, y, incy ), blas::Error );
    assert_throw( blas::symv( policy, layout,    uplo,    -1, alpha, A, lda, x, incx, beta, y, incy ), blas::Error );
    assert_throw( blas::symv( policy, layout,    uplo,     n, alpha, A, n-1, x, incx, beta, y, incy ), blas::Error );
    assert_throw( blas::symv( policy, layout,    uplo,     n, alpha, A, lda, x,    0, beta, y, incy ), blas::Error );
    assert_throw( blas::symv( policy, layout,    uplo,     n, alpha, A, lda, x, incx, beta, y,    0 ), blas::Error );
    ...
    double time;
    {
      ...
      blas::symv( policy, layout, uplo, n, alpha, dA, lda, dx, incx, beta, dy, incy );
      time = timer.seconds();
...
void test_symv( Params& params, bool run )
{
    switch (params.datatype.value()) {
        ...
        case libtest::DataType::Double:
            ...
            break;
            // XXX TODO: cblas dispatch requires LAPACK
            /*
