...
void test_trmv_work( Params& params, bool run, Policy policy = blam_default_policy )
{
    namespace blas = blam;
    ...
    // test error exits
    assert_throw( blas::trmv( policy, Layout(0), uplo,    trans, diag,     n, A, lda, x, incx ), blas::Error );
    assert_throw( blas::trmv( policy, layout,    Uplo(0), trans, diag,     n, A, lda, x, incx ), blas::Error );
    assert_throw( blas::trmv( policy, layout,    uplo,    Op(0), diag,     n, A, lda, x, incx ), blas::Error );
    assert_throw( blas::trmv( policy, layout,    uplo,    trans, Diag(0),  n, A, lda, x, incx ), blas::Error );
    assert_throw( blas::trmv( policy, layout,    uplo,    trans, diag,    -1, A, lda, x, incx ), blas::Error );
    assert_throw( blas::trmv( policy, layout,    uplo,    trans, diag,     n, A, n-1, x, incx ), blas::Error );
    assert_throw( blas::trmv( policy, layout,    uplo,    trans, diag,     n, A, lda, x,    0 ), blas::Error );
    ...
    double time;
    {
      ...
      blas::trmv( policy, layout, uplo, trans, diag, n, dA, lda, dx, incx );
      time = timer.seconds();
