...
void test_her2_work( Params& params, bool run, Policy policy = blam_default_policy )
{
    namespace blas = blam;
    ...
    // test error exits
    assert_throw( blas::her2( policy, Layout(0), uplo,     n, alpha, x, incx, y, incy, A, lda ), blas::Error );
    assert_throw( blas::her2( policy, layout,    Uplo(0),  n, alpha, x, incx, y, incy, A, lda ), blas::Error );
    assert_throw( blas::her2( policy, layout,    uplo,    -1, alpha, x, incx, y, incy, A, lda ), blas::Error );
    assert_throw( blas::her2( policy, layout,    uplo,     n, alpha, x,    0, y, incy, A, lda ), blas::Error );
    assert_throw( blas::her2( policy, layout,    uplo,     n, alpha, x, incx, y,    0, A, lda ), blas::Error );
    assert_throw( blas::her2( policy, layout,    uplo,     n, alpha, x, incx, y, incy, A, n-1 ), blas::Error );
    ...
    double time;
    {
      ...
      blas::her2( policy, layout, uplo, n, alpha, dx, incx, dy, incy, dA, lda );
      time = timer.seconds();
